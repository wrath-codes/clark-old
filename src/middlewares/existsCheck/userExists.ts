 ...
 * @author Raphael Vaz
 */
export const userExistsId = async (request: Request, response: Response, next: NextFunction) => {
 ...
 * @author Raphael Vaz
 */
export const userExistsEmail = async (request: Request, response: Response, next: NextFunction) => {
